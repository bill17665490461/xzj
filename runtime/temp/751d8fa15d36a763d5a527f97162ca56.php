<?php /*a:2:{s:83:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\index\investmentpark.html";i:1537949238;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1537942474;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1537949240", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<div class="park_rank">
	...
	<dl class="parkRank_main">
        ...
        <dd class="parkRank_info">
            ...
            <a href="/index.php/investmentpark/<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['title']); ?></a></div>
			...
			<div class="rank_p"><span class="padR-10">园区地址：</span><?php echo area($vo['province']); ?>><?php echo area($vo['city']); ?>><?php echo area($vo['district']); ?>><?php echo htmlentities($vo['address']); ?></div>
            ...
            <span class="fc_red"><?php echo htmlentities($vo['hits']); ?></span>&nbsp;</i> 
            
            <?php echo date('Y-m-d',$vo['create_time']); ?></div>
        </dd>
        <div class="clear"></div>
    </dl>
    <?php endforeach; endif; else: echo "" ;endif; ?>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1537949240", "id,cname,title", "", "create_time desc", "6", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
