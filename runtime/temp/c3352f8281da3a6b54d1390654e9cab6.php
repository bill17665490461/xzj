<?php /*a:2:{s:79:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\index\government.html";i:1537960152;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1541473421;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1541473592", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<div class="park_rank">
	...
	<dl class="parkRank_main">
    	...
    	<img src="/public/uploads/<?php echo htmlentities($vo['logo']['path']); ?>" width="267" height="180"></a></dt>
        <dd class="parkRank_info">
        	<div class="rank_title"><a href="/index.php/government/<?php echo htmlentities($vo['id']); ?>" target="_blank"><?php echo htmlentities($vo['title']); ?></a></div>
            <div class="rank_p"><span class="padR-10">园区类别：</span><?php echo getCateType($vo['category']); ?></div>
            <div class="rank_p"><span class="padR-10">园区级别：</span><?php echo htmlentities($vo['level']); ?></div>
			<div class="rank_p"><span class="padR-10">园区地址：</span><?php echo htmlentities($vo['address']); ?></div>
            <div class="rank_p"><span class="padR-10">招商单位：</span><?php echo htmlentities($title); ?></div>
			            <div class="rank_p">
            
            <span class="padR-10">发布时间：</span>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("article", "status=1 and create_time <1541473592", "id,cname,title", "", "create_time desc", "6", null, 36, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
