<?php /*a:2:{s:78:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\index\contactUs.html";i:1541487193;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1541487051;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
...
<!-- LOGO 改为单独CSS-->
     <div class="logo_area">
        <div class="logo">
            <a href="/index.php" style="height:65px;background:url(/public/uploads/<?php echo config('web_site_logo')['path']; ?>) no-repeat right"></a>
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1541487195", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<!--end-->
	...
	<!--导航栏-->
	<style type="text/css">
		   .layui-tab-content img{width: auto;margin: 0 auto}
	</style>
	...
	<div class="neirong">
		...
		<div class="yidong">
		<h2>公司信息</h2>
		<?php echo htmlspecialchars_decode($getInfo['content']); ?>
		</div>	
		</div>
		<div class="right-tp">
			<img src="/public/uploads/<?php echo htmlentities($getInfo['img']); ?>">
		</div>
		</div>
			...
			<div class="layui-tab">
				<ul class="layui-tab-title">
			  	...
			  	<div class="layui-tab-content">
				    <div class="layui-tab-item layui-show" style="padding: 10px 30px 30px 30px">
				    	<?php echo htmlspecialchars_decode($getInfo['briefintroduction']); ?>
				    </div>
				    <div class="layui-tab-item">
						<div class="left-regiter">
						       <p>&nbsp;</p>
						       <p>&nbsp;</p>
						       <p>&nbsp;</p>
						       <p>&nbsp;</p>
						    <form class="layui-form"  method="post" action="<?php echo url('/contactus',['contactus'=>1]); ?>">
						    	<div class="layui-form-item">
								<label class="layui-form-label">留言标题：</label>
									<div class="layui-input-block">
										<input type="text" name="title" placeholder="请输入" required="required" autocomplete="off" class="layui-input" style="width: 80%" />
									</div>
								</div>
						    	<div class="layui-form-item">
								<label class="layui-form-label">咨询人单位：</label>
									<div class="layui-input-block">
										<input type="text" name="company" placeholder="请输入" autocomplete="off" class="layui-input" style="width: 80%">
									</div>
								</div>
								<div class="layui-form-item">
								<label class="layui-form-label">咨询人姓名：</label>
									<div class="layui-input-block">
										<input type="text" name="name" placeholder="请输入" autocomplete="off" class="layui-input" style="width: 80%">
									</div>
								</div>
								<div class="layui-form-item">
								<label class="layui-form-label">联系手机号：</label>
									<div class="layui-input-block">
										<input type="number" name="telephone" placeholder="请输入" autocomplete="off" class="layui-input" style="width: 80%">
									</div>
								</div>
								<div class="layui-form-item">
								<label class="layui-form-label">E-mail</label>
									<div class="layui-input-block">
										<input type="email" name="email" placeholder="请输入" autocomplete="off" class="layui-input" style="width: 80%">
									</div>
								</div>
								<div class="layui-form-item">
								<label class="layui-form-label">QQ号码：</label>
									<div class="layui-input-block">
										<input type="text" name="qq" placeholder="请输入" autocomplete="off" class="layui-input" style="width: 80%">
									</div>
								</div>
								<div class="layui-form-item layui-form-text">
								    <label class="layui-form-label">留言内容：</label>
								    <div class="layui-input-block">
								      <textarea placeholder="请输入内容" required="required" name="content" class="layui-textarea"  style="width: 80%"></textarea>
								    </div>
								 </div>
								<div class="layui-form-item" style="text-align: center">
								    <div class="layui-input-block" style="margin-left: 0px">
								      <button class="layui-btn layui-btn-submit" lay-submit lay-filter="*">发布留言</button>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("article", "status=1 and create_time <1541487195", "id,cname,title", "", "create_time desc", "6", null, 36, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
