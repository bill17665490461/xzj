<?php /*a:2:{s:58:"E:\phpstudy\WWW\xzj\application\admin\view\column\add.html";i:1535618190;s:54:"E:\phpstudy\WWW\xzj\application\admin\view\layout.html";i:1537961176;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<?php if(empty($modelList) || (($modelList instanceof \think\Collection || $modelList instanceof \think\Paginator ) && $modelList->isEmpty())): ?>
<div class="alert alert-warning">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <i class="fa fa-warning"></i> 请先在'模型管理'中添加栏目内容模型
</div>
<?php endif; if(empty($template_list) || (($template_list instanceof \think\Collection || $template_list instanceof \think\Paginator ) && $template_list->isEmpty())): ?>
<div class="alert alert-warning">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <i class="fa fa-warning"></i> 请先在application\home\view\defaults\column\index\目录下添加栏目模板
</div>
<?php endif; if(empty($template_content) || (($template_content instanceof \think\Collection || $template_content instanceof \think\Paginator ) && $template_content->isEmpty())): ?>
<div class="alert alert-warning">
    <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="panel-body">
                    ...
                    <fieldset class="form-group">
                        ...
                        <select id="path" name="path" class="form-control  select2-hidden-accessible" style="width: 100%" data-allow-clear="true" tabindex="-1" aria-hidden="true">
                            ...
                            <option value="<?php echo htmlentities($vo['path']); ?><?php echo htmlentities($vo['id']); ?>,"><?php echo str_repeat('┝┈┈', $vo['deep']-1); ?><?php echo htmlentities($vo['title']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </fieldset>
                    ...
                    <fieldset class="form-group listApagecolumn">
                        ...
                        <select id="template_list" name="template_list" class="form-control  select2-hidden-accessible" style="width: 100%" data-allow-clear="true" tabindex="-1" aria-hidden="true">
                            ...
                            <option value="<?php echo htmlentities($key); ?>" data-mid="<?php echo htmlentities($vo['mid']); ?>"><?php echo htmlentities($vo['name']); ?> <?php echo htmlentities($vo['title']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </fieldset>
                    <fieldset class="form-group listcolumn">
