<?php /*a:2:{s:90:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\content\companyNews_content.html";i:1541474061;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1541473421;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1541474063", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<div class="clear"></div>
<!--左侧列表开始-->
     <div class="inspleft f_l">
	 <div class="con_tainer">
<!--title begin-->
	     <div class="news_tit"><h1><?php echo htmlentities($data['title']); ?></h1></div>
<!--title end-->
<!--author begin-->
         <div class="news_top"><span class="f_l">发布时间：<?php echo date('Y-m-d H:i:s',$data['create_time']); ?></span><span class="f_r">来源：<?php echo htmlentities($title); ?></span></div>
<!--ahthor begin-->
	<div class="news_main">
<!--abstract begin-->
		 <div class="news_abstract"><strong>【摘要】</strong><?php echo htmlspecialchars_decode($data['abstract']); ?></div>
<!--abstract end-->
<!--newscontent begin-->
<br>
		
	<div class="news_body" deep="5">
...
<div class="pagebox">
    ...
    <div class="pagenext"><strong>上一篇：</strong> <?php if(empty($prev) || (($prev instanceof \think\Collection || $prev instanceof \think\Paginator ) && $prev->isEmpty())): ?>没有了 ...<?php else: ?><a href="<?php echo htmlentities($prev['url']); ?>"><?php echo htmlentities($prev['title']); ?></a><?php endif; ?></div>
	
    <div class="pagenext"><strong>下一篇：</strong><?php if(empty($next) || (($next instanceof \think\Collection || $next instanceof \think\Paginator ) && $next->isEmpty())): ?>没有了 ...<?php else: ?><a href="<?php echo htmlentities($next['url']); ?>"><?php echo htmlentities($next['title']); ?></a><?php endif; ?></div>
	
    <div class="pagelink">
        <!-- Baidu Button BEGIN -->

<script type="text/javascript" id="bdshare_js" data="type=tools&amp;uid=753413" src="/public/static/home/js/bds_s_v2.js"></script>
...
<div class="inspright f_r">
    ...
    <div class="inspR_rank">
    	...
    	<h4 class="sdtit"><span><img src="/public/static/home/image/rmtzxm.jpg"></span>最新招商峰会</h4>
                
        <ul class="inspRlink">
        	<?php $sql_list=model('ModelField')->getDataList("articles", "status=1 and create_time <1541474063", "id,cname,title,logo,starttime,endtime,hits", "", "create_time desc", "0,12", null, 30, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
			...
			<a href="/index.php/articles/<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>" target="_blank">
			<span class="num top3" style="color: red"><?php echo htmlentities($vo['id']); ?></span><span class="tit"><?php echo htmlentities($vo['title']); ?></span><span style="float: right;padding-right: 10px;"><?php echo htmlentities($vo['hits']); ?></span>
			</a>
			</li>
		    <?php endforeach; ?>
        </ul>
    ...
    <!--one begin-->
    <div class="inspR_rank">
        <h4 class="sdtit"><span><img src="/public/static/home/image/icon2.jpg"></span>热点新闻</h4>
        
        <ul class="inspRlink">
        	<?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1541474063", "id,cname,title,logo,hits", "", "hits desc", "12", null, 17, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
			<li onmouseover="this.style.backgroundColor=&#39;#f1f1f1&#39;" onmouseout="this.style.backgroundColor=&#39;#ffffff&#39;" style="background-color: rgb(255, 255, 255);">
            <a href="/index.php/journalism/<?php echo htmlentities($vo['id']); ?>" target="_blank">
            	...
            	<span class="tit"><?php echo htmlentities($vo['title']); ?></span>
            	<span style="float: right;padding-right: 10px;"><?php echo htmlentities($vo['hits']); ?></span>
            </a>
            </li>
            <?php endforeach; ?>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("article", "status=1 and create_time <1541474063", "id,cname,title", "", "create_time desc", "6", null, 36, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
