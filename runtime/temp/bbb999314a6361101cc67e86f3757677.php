<?php /*a:4:{s:78:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\content\content.html";i:1536118363;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1541473421;s:63:"E:\phpstudy\WWW\xzj\application\home\view\defaults\comment.html";i:1532077198;s:61:"E:\phpstudy\WWW\xzj\application\home\view\defaults\right.html";i:1532077259;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1541473426", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
    ...
    <div class="ui  grid stackable">
        <div class="ten wide column">
            ...
            <div class="ui segment">
                ...
                <div class="contentInfo"><i class="time icon"></i><?php echo date('Y-m-d H:i:s',$data['create_time']); ?>&nbsp&nbsp&nbsp<i class="unhide icon"></i> <?php echo htmlentities($data['hits']); ?> &nbsp&nbsp&nbsp <i class="write icon"></i><?php echo htmlentities($data['source']); ?></div>
...
<div class="ui bottom attached tab segment" data-tab="second">
    <div class="ui comments">
        <?php $sql_list=model('ModelField')->getDataList("comment", "mid='".$info['model_id']."' and did='".$data['id']."' and status='1' and create_time <1541473426", "id,commenter,message,create_time", "", "orders,id desc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="comment">
            <div class="content">
...
<div class="ui segment">
    ...
    <div class="ui two column grid ">
        <?php $sql_list=model('ModelField')->getDataList("photo", "status='1' and create_time <1541473426", "id,cname,title,cover", "", "orders,id desc", "2", null, 0, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="column">
...
<div class="ui segment">
    ...
    <div class="ui divided list articleList">
        <?php $sql_list=model('ModelField')->getDataList("article", "status='1' and create_time <1541473426", "id,cname,title,description,create_time", "", "hits desc", "4", null, 0, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="item">
...
<div class="ui segment">
    ...
    <div class="ui divided list articleList">
        <?php $sql_list=model('ModelField')->getDataList("article", "status='1' and create_time <1541473426", "id,cname,title,description,create_time", "", "[rand]", "4", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="item">
            <span class="right floated"><?php echo date('Y-m-d',$vo['create_time']); ?></span>
            <a href="<?php echo htmlentities($vo['url']); ?>"><i class="file outline icon"></i><?php echo htmlentities($vo['title']); ?></a>
        </div>
...
<div class="ui segment">
    ...
    <div class="ui two column grid ">
        <?php $sql_list=model('ModelField')->getDataList("product", "status='1' and create_time <1541473426", "id,cname,title,cover", "", "create_time desc", "2", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="column">
            <div class="ui fluid image">
                <a href="<?php echo htmlentities($vo['url']); ?>" class="ui medium rounded  image" >
                    <img  src="/public/uploads/<?php echo htmlentities($vo['cover']['thumb']); ?>" alt="<?php echo htmlentities($vo['title']); ?>">
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("article", "status=1 and create_time <1541473426", "id,cname,title", "", "create_time desc", "6", null, 36, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
