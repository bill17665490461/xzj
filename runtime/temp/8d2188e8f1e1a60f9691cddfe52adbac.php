<?php /*a:2:{s:68:"E:\phpstudy\WWW\xzj\application\home\view\defaults\index\search.html";i:1538011029;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1537942474;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1538011299", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<!--面包屑end-->
		<!--one con begin-->
	    <?php if(!empty($searchList['investmentpark'])): if(is_array($searchList['investmentpark']) || $searchList['investmentpark'] instanceof \think\Collection || $searchList['investmentpark'] instanceof \think\Paginator): $i = 0; $__LIST__ = $searchList['investmentpark'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	  	<div class="list_con" style="padding: 5px 0px">
	       <div class="list_tit">
	       <a href="/index.php/<?php echo htmlentities($vo['cname']); ?>/<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['title']); ?></a>
	       <span style="font-weight: 100;float: right"><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></span></div>
...
<div class="inspR_rank">
	...
	<div class="blank10"></div>
	<h4 class="sdtit"><span>
	<img src="/public/static/home/image/rmtzxm.jpg"></span>相关政府招商</h4>
            
    <ul class="inspRlink">
    	<?php if(!empty($searchList['government'])): if(is_array($searchList['government']) || $searchList['government'] instanceof \think\Collection || $searchList['government'] instanceof \think\Paginator): $i = 0; $__LIST__ = $searchList['government'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		...
		<a href="/index.php/<?php echo htmlentities($vo['cname']); ?>/<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>">
	...
	<div class="blank10"></div>
	<h4 class="sdtit"><span>
	<img src="/public/static/home/image/rmtzxm.jpg"></span>相关招商峰会</h4>
            
    <ul class="inspRlink">
    	<?php if(!empty($searchList['articles'])): if(is_array($searchList['articles']) || $searchList['articles'] instanceof \think\Collection || $searchList['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $searchList['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<li onmouseover="this.style.backgroundColor=&#39;#f1f1f1&#39;" onmouseout="this.style.backgroundColor=&#39;#ffffff&#39;" style="background-color: rgb(255, 255, 255);">
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1538011299", "id,cname,title", "", "create_time desc", "6", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
