<?php /*a:2:{s:77:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\index\articles.html";i:1536387964;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1537942474;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1537943525", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
   ...
   <div class="NSadd">
    <a class="section" href="<?php echo url('index/index'); ?>"> 首页</a>&gt;
      ...
      <?php if(is_array($list['data']) || $list['data'] instanceof \think\Collection || $list['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	  	<div class="list_con">
	       <div class="list_tit">
	       <a href="/index.php/articles/<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['title']); ?></a></div>
		   <div class="list_Introduction">　　<?php echo htmlentities($vo['abstract']); ?>
           [<a href="/index.php/articles/<?php echo htmlentities($vo['id']); ?>">全文</a>]</div>
...
<div class="inspright f_r">
        ...
        <div class="inspR_rank">
            <h4 class="sdtit"><span><img src="/public/static/home/image/icon2.jpg"></span>最新招商峰会</h4>
                
            <ul class="inspRlink">
                <?php $sql_list=model('ModelField')->getDataList("articles", "status=1 and create_time <1537943525", "id,title,cname", "", "create_time desc", "0,12", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1537943525", "id,cname,title", "", "create_time desc", "6", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
