<?php /*a:2:{s:67:"E:\phpstudy\WWW\xzj\application\home\view\defaults\index\index.html";i:1538301467;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1541475764;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1541475765", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<!--第一屏内容开始-->
<div class="Prak First1">
     <div class="CFCK22">
	<div class="CFnewstit" style="margin-top:6px;">
		<div class="CFTIT">招商峰会</div>
		<div class="Cmore"></div>
		<div class="CFmall"><a href="/index.php/articles" target="_blank">更多</a></div>
	</div>
	<div class="CF_jdshow">
	<script type="text/javascript" src="/public/static/home/js/lrtk22.js"></script>
<!-- 焦点图代码开始 -->
<div id="zSlider">
	<div id="picshow">
		<div id="picshow_img">
			...
			<?php $sql_list=model('ModelField')->getDataList("articles", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "orders asc", "12", null, 30, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
			  <li style="display: none;">
			  <a href="/index.php/articles/<?php echo htmlentities($vo['id']); ?>">
			  <img src="/public/uploads/<?php echo htmlentities($vo['logo']['path']); ?>" alt="<?php echo htmlentities($vo['title']); ?>"></a></li>
			  <?php endforeach; ?>
			</ul>
		</div>
		<div id="picshow_tx">
			...
			<ul>
			   	<?php $sql_list=model('ModelField')->getDataList("articles", "status=1 and create_time <1541475765", "id,cname,title,logo,starttime,endtime,address", "", "orders asc", "0,12", null, 30, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
				<li style="display: none;">
					<h3><a href="/index.php/articles/<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>"><?php echo htmlentities($vo['title']); ?></a></h3>
					<p><?php echo date('Y-m-d H:i',$vo['starttime']); ?>至 <?php echo date('Y-m-d H:i',$vo['endtime']); ?>结束 
					　　峰会地址：<?php echo htmlentities($vo['address']); ?></p>
				</li>
			 <?php endforeach; ?>
			</ul>
		</div>
	...
	<div id="select_btn">
		...
		<ul>
		   	<?php $sql_list=model('ModelField')->getDataList("articles", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "orders asc", "0,12", null, 30, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
		  <li class="" style="border: none;">
		  <a href="/index.php/articles/<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>"><span class="select_text"><?php echo htmlentities($vo['title']); ?></span></a>
		  </li>
		   	<?php endforeach; ?>
...
<!--招商引资项目推荐开始-->
<div class="Menupark">
     <div class="Menured">中国热门招商引资新闻</div>
</div>
<div class="layui-progress layui-progress-big" style="border-radius: 0px;background: #333;height:10px">
  <div class="layui-progress-bar layui-bg-green" lay-percent="35%"  style="border-radius: 0px;background: #f4292c!important;height:10px;"></div>
</div>
<div class="area blank10"></div>
<div class="Prak">
     <div class="Bpark">
      <div class="Pnewstit">
	      <div class="ParkTIT">最新新闻质询</div>
		  <div class="Parkmore"></div>
		  <div class="Parkmall"><a href="/index.php/journalism" target="_blank">更多</a></div>
	  </div>
	  <div class="Pnews">
       	<ul>
	      	<?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "create_time desc", "12", null, 17, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<!-- 招商引资项目推荐start-->
	    <div class="parkimg">
		  <ul>
		  <?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "create_time asc", "12", null, 17, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
		  
		     <li>
				<div class="smalltu">
				<div class="STu">
				<a href="/index.php/journalism/<?php echo htmlentities($vo['id']); ?>" target="_blank">
				<img src="/public/uploads/<?php echo htmlentities($vo['logo']['path']); ?>" alt="<?php echo htmlentities($vo['title']); ?>" border="0"></a></div>
				<div class="STumenu"><p>
				<a href="/index.php/journalism/<?php echo htmlentities($vo['id']); ?>" target="_blank"><?php echo htmlentities($vo['title']); ?></a></p></div>
				</div>
			</li>
   			<?php endforeach; ?>
...
<!--招商引资项目推荐开始-->
<div class="Menupark">
     <div class="Menured">中国热门产业园区招商</div>
...
<div class="area blank10"></div>
<div class="Prak">
     <div class="Bpark Bpark-zf" style="float: left;">
	      <div class="Pnewstit">
		      <div class="ParkTIT">最新园区投资项目</div>
			  <div class="Parkmore"></div>
			  <div class="Parkmall"><a href="/index.php/investmentpark" target="_blank">更多</a></div>
		  </div>
		  <div class="Pnews">
		       <ul>
			      <?php $sql_list=model('ModelField')->getDataList("investmentpark", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "create_time asc", "12", null, 18, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
  				  <li><a href="/index.php/investmentpark/<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>" target="_blank"><?php echo htmlentities($vo['title']); ?></a></li>
  				  <?php endforeach; ?>
...
<!-- 招商引资项目推荐start-->
	    <div class="parkimg">
		  <ul>
		     ...
		     <?php $sql_list=model('ModelField')->getDataList("investmentpark", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "create_time asc", "12", null, 18, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
		  
		     <li>
<div class="smalltu">
<div class="STu">
<a href="/index.php/investmentpark/<?php echo htmlentities($vo['id']); ?>" target="_blank"><img src="/public/uploads/<?php echo htmlentities($vo['logo']['path']); ?>" alt="<?php echo htmlentities($vo['title']); ?>" border="0"></a></div>
<div class="STumenu"><p>
<a href="/index.php/investmentpark/<?php echo htmlentities($vo['id']); ?>" target="_blank"><?php echo htmlentities($vo['title']); ?></a></p></div>
</div>
</li><?php endforeach; ?>
...
<!--招商引资项目推荐开始-->
<div class="Menupark">
     <div class="Menured">政府招商引资信息</div>
...
<!-- 招商引资项目推荐start-->
	    <div class="parkimg">
		 ...
		 <?php $sql_list=model('ModelField')->getDataList("government", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "create_time asc", "0,12", null, 20, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
		     <li>
			<div class="smalltu">
			<div class="STu">
				<a href="/index.php/government/<?php echo htmlentities($vo['id']); ?>" target="_blank"><img src="/public/uploads/<?php echo htmlentities($vo['logo']['path']); ?>" alt="<?php echo htmlentities($vo['title']); ?>" border="0"></a>
			</div>
			<div class="STumenu"><p><a href="/index.php/government/<?php echo htmlentities($vo['id']); ?>" target="_blank"><?php echo htmlentities($vo['title']); ?></a></p></div>
			</div>
			</li>
		<?php endforeach; ?>
		  </ul>
...
<!-- 园区推荐end-->
	 ...
	 <div class="Bpark Bpark-zf" style="float: left;">
	      <div class="Pnewstit">
		      <div class="ParkTIT">最新投资项目</div>
			  <div class="Parkmore"></div>
			  <div class="Parkmall"><a href="/index.php/government">更多</a></div>
		  </div>
		  <div class="Pnews">
		       <ul>
			      <?php $sql_list=model('ModelField')->getDataList("government", "status=1 and create_time <1541475765", "id,cname,title,logo", "", "create_time asc", "12", null, 20, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
  				  <li><a href="/index.php/government/<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>"><?php echo htmlentities($vo['title']); ?></a></li>      
  				  <?php endforeach; ?>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        <h4><i></i><span class="more"><a href="/index.php/companyNews">更多</a></span>公司动态</h4>
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("article", "status=1 and create_time <1541475765", "id,cname,title", "", "create_time desc", "6", null, 36, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
                    <li><a href="/index.php/companyNews/<?php echo htmlentities($vo['id']); ?>" title="<?php echo htmlentities($vo['title']); ?>"><?php echo htmlentities($vo['title']); ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
