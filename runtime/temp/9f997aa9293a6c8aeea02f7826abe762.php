<?php /*a:2:{s:89:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\content\government_content.html";i:1537950844;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1541473421;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1541473586", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<div class="xq_left f_l">
    ...
    <div class="focusbox">         
        <div class="focusimg" style="width: 430px;height: 380px">
        	...
        	<img src="/public/uploads/<?php echo htmlentities($data['logo']['path']); ?>" alt="<?php echo htmlentities($data['title']); ?>" style="width: 98%;height: 98%">
...
<div class="xqL_info f_r">
  ...
  <div class="rank_p"><span class="padR-10">区域面积：</span><?php echo htmlentities($data['area']); ?>平方千米
   </div>
   <div class="rank_p"><span class="padR-10">联系部门：</span><?php echo htmlentities($data['department']); ?></div>
   <div class="rank_p"><span class="padR-10">投资规模：</span><?php echo htmlentities($data['scale']); ?>万</div>
    <div class="rank_p"><span class="padR-10">常住人口：</span><?php echo htmlentities($data['population']); ?>万</div>
    
    <div class="rank_p"><span class="padR-10">基础设施：</span><?php echo htmlentities($data['infrastructure']); ?></div>
    
  <div class="rank_p"><span class="padR-10">招商地址：</span><?php echo area($data['province']); ?>><?php echo area($data['city']); ?>><?php echo area($data['district']); ?>><?php echo htmlentities($data['address']); ?></div>
  <div class="rank_p"><span class="padR-10">联系方式：</span><span class="fc_r20"><?php echo htmlentities($data['contact']); ?></span></div>
...
<!--项目介绍begin-->
  ...
  <div class="layui-tab-content" style="border-left: 1px solid #eee;border-bottom: 1px solid #eee;border-right: 1px solid #eee;">
    ...
    <div class="layui-tab-item"><?php echo htmlspecialchars_decode($data['region']); ?></div>
    <div class="layui-tab-item"><?php echo htmlspecialchars_decode($data['town']); ?></div>
    <div class="layui-tab-item"><?php echo htmlspecialchars_decode($data['specialty']); ?></div>
...
<!--右侧 begain-->
        <div class="inspright f_r">
        	<!--one end-->
            	...
            	<span class="more"><a href="/index.php/government">更多&gt;&gt;</a></span>最新招商信息</h4>
                
              <ul class="inspRlink">
			           <?php $sql_list=model('ModelField')->getDataList("government", "status=1 and create_time <1541473586", "id,title,cname", "", "create_time desc", "0,12", null, 20, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
			   			       ...
			   			       <a href="/index.php/government/<?php echo htmlentities($vo['id']); ?>">
        	...
        	<div class="inspR_rank">
            	...
            	<span class="more"><a href="/index.php/government">更多&gt;&gt;</a></span>热点政府招商信息</h4>
                
                <ul class="inspRlink">
                 	<?php $sql_list=model('ModelField')->getDataList("government", "status=1 and create_time <1541473586", "id,title,cname", "", "hits desc", "0,12", null, 20, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
                   <li onmouseover="this.style.backgroundColor=&#39;#f1f1f1&#39;" onmouseout="this.style.backgroundColor=&#39;#ffffff&#39;" style="background-color: rgb(255, 255, 255);">
                     <a href="/index.php/government/<?php echo htmlentities($vo['id']); ?>">
                    <span class="num top3" style="color: red"><?php echo htmlentities($vo['id']); ?></span>
                    <span class="tit"><?php echo htmlentities($vo['title']); ?></span></a>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("article", "status=1 and create_time <1541473586", "id,cname,title", "", "create_time desc", "6", null, 36, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
