<?php /*a:2:{s:57:"E:\phpstudy\WWW\xzj\application\admin\view\field\add.html";i:1511946842;s:54:"E:\phpstudy\WWW\xzj\application\admin\view\layout.html";i:1537961176;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<ul class="nav nav-tabs">
    ...
    <li class="pull-xs-right label label-primary">"<?php echo htmlentities($modelTitle); ?>"模型字段添加</li>
</ul>
<form  method="post" action="<?php echo url('add',['mid'=>$mid]); ?>">
                ...
                <div class="panel-body">
                    ...
                    <fieldset class="form-group">
                        ...
                        <select id="type" name="type" class="form-control select2-example select2-hidden-accessible" style="width: 100%" data-allow-clear="true" tabindex="-1" aria-hidden="true">
                            ...
                            <option value="<?php echo htmlentities($vo['name']); ?>" data-define="<?php echo htmlentities($vo['default_define']); ?>" data-ifoption="<?php echo htmlentities($vo['ifoption']); ?>" data-ifstring="<?php echo htmlentities($vo['ifstring']); ?>"><?php echo htmlentities($vo['title']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </fieldset>
                    <fieldset class="form-group">
                    ...
                    <div id="imgset" style="display:none">
                        ...
                        <div id="thumbset" style="display:none">
                            <fieldset class="form-group">
                                <label>缩略图大小</label>
                                <input type="text" class="form-control" name="jsonrule[thumb][size]" placeholder="长,宽" value="<?php echo config('upload_image_thumb'); ?>">
                            </fieldset>
                            <fieldset class="form-group">
                                <label style="clear:both; display: block">缩略图裁剪位置</label>
                                <?php $thumb_type=config('upload_image_thumb_type'); ?>
                    ...
                    <div id="fileset" style="display:none">
                        <fieldset class="form-group">
                            <label>文件类型*</label>
                            <input id="filetype" type="text" class="form-control" name="jsonrule[file][type]" placeholder="" value="<?php echo config('upload_file_ext'); ?>">
                            <small class="text-muted">不得超出系统配置：<?php echo config('upload_file_ext'); ?>范围</small>
                        </fieldset>
                        <fieldset class="form-group">
                            <label>文件大小限制</label>
                            <input type="number" class="form-control" name="jsonrule[file][size]" placeholder="" value="<?php echo config('upload_file_size'); ?>">
