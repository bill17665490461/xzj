<?php /*a:2:{s:89:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\content\journalism_content.html";i:1536397433;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1538301438;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1541471174", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<!--ahthor begin-->
	<div class="news_main">
<!--abstract begin-->
		 <div class="news_abstract"><strong>【摘要】</strong>　　<?php echo htmlentities($data['abstract']); ?></div>
<!--abstract end-->
<!--newscontent begin-->
<br>
...
<div class="inspright f_r">
    ...
    <div class="inspR_rank">
        ...
        <ul class="inspRlink">
        	<?php $sql_list=model('ModelField')->getDataList("articles", "status=1 and create_time <1541471174", "id,cname,title,logo,starttime,endtime,hits", "", "create_time desc", "0,12", null, 30, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
    ...
    <div class="inspR_rank">
        ...
        <ul class="inspRlink">
        	<?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1541471174", "id,cname,title,logo,hits", "", "hits desc", "12", null, 17, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
			<li onmouseover="this.style.backgroundColor=&#39;#f1f1f1&#39;" onmouseout="this.style.backgroundColor=&#39;#ffffff&#39;" style="background-color: rgb(255, 255, 255);">
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1541471174", "id,cname,title", "", "create_time desc", "6", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
