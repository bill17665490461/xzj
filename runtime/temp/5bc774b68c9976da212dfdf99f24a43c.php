<?php /*a:3:{s:59:"E:\phpstudy\WWW\xzj\application\admin\view\content\add.html";i:1537960068;s:54:"E:\phpstudy\WWW\xzj\application\admin\view\layout.html";i:1537961176;s:57:"E:\phpstudy\WWW\xzj\application\admin\view\inputItem.html";i:1536561739;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel">
    <div class="panel-heading">
        <div class="panel-title">添加【<?php echo htmlentities($columnTitle); ?>】下的内容</div>
    </div>
    <form class="panel-body" method="post" action="<?php echo url('add',['mid'=>$mid,'cname'=>$cname]); ?>">
        <?php if($cname=='government' OR $cname=='investmentpark' OR $cname == 'articles'): ?>
...
<?php break; endswitch; endif; endforeach; endif; else: echo "" ;endif; if(isset($placeList) && !empty($placeList)): ?>
        <fieldset class="form-group">
            ...
            <label class="custom-control custom-checkbox checkbox-inline">
                <input type="checkbox" name="modelField[places][]" class="custom-control-input" value="<?php echo htmlentities($key); ?>">
