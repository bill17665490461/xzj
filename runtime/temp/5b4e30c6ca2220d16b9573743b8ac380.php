<?php /*a:3:{s:73:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\index\list.html";i:1536287711;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1538301438;s:61:"E:\phpstudy\WWW\xzj\application\home\view\defaults\right.html";i:1532077259;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1538967033", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        ...
        <div class="ten wide column">
            ...
            <div class="ui divided  items">
                ...
                <div class="item">
                    ...
                    <?php endif; ?>
                    <div class="content">
                        <a class="header" href="<?php echo htmlentities($vo['url']); ?>" style="color:<?php echo htmlentities($vo['color']); ?>"><div class="ui blue horizontal label"><?php echo htmlentities($columList[$vo['cname']]['title']); ?></div> <?php echo htmlentities($vo['title']); ?></a>
                        <div class="meta">
                            <span><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></span>
                        </div>
                        <div class="description">
                            <p>
                                <?php if(is_array($vo['keywords']) || $vo['keywords'] instanceof \think\Collection || $vo['keywords'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['keywords'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <a class="ui tag label" href="<?php echo url('index/search'); ?>?keyword=<?php echo htmlentities($v); ?>"><?php echo htmlentities($v); ?></a> 
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </p>
           ...
           <div class="ui icon buttons blue">
               <div class="ui button">一共<?php echo htmlentities($list['total']); ?>条 <?php echo htmlentities($list['last_page']); ?>页 每页<?php echo htmlentities($list['per_page']); ?>条</div>
           </div>
            <?php echo $page; ?>
        </div>
...
<div class="ui segment">
    ...
    <div class="ui two column grid ">
        <?php $sql_list=model('ModelField')->getDataList("photo", "status='1' and create_time <1538967033", "id,cname,title,cover", "", "orders,id desc", "2", null, 0, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="column">
...
<div class="ui segment">
    ...
    <div class="ui divided list articleList">
        <?php $sql_list=model('ModelField')->getDataList("article", "status='1' and create_time <1538967033", "id,cname,title,description,create_time", "", "hits desc", "4", null, 0, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="item">
...
<div class="ui segment">
    ...
    <div class="ui divided list articleList">
        <?php $sql_list=model('ModelField')->getDataList("article", "status='1' and create_time <1538967033", "id,cname,title,description,create_time", "", "[rand]", "4", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="item">
            <span class="right floated"><?php echo date('Y-m-d',$vo['create_time']); ?></span>
            <a href="<?php echo htmlentities($vo['url']); ?>"><i class="file outline icon"></i><?php echo htmlentities($vo['title']); ?></a>
        </div>
...
<div class="ui segment">
    ...
    <div class="ui two column grid ">
        <?php $sql_list=model('ModelField')->getDataList("product", "status='1' and create_time <1538967033", "id,cname,title,cover", "", "create_time desc", "2", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="column">
            <div class="ui fluid image">
                <a href="<?php echo htmlentities($vo['url']); ?>" class="ui medium rounded  image" >
                    <img  src="/public/uploads/<?php echo htmlentities($vo['cover']['thumb']); ?>" alt="<?php echo htmlentities($vo['title']); ?>">
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1538967033", "id,cname,title", "", "create_time desc", "6", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
