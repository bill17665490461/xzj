<?php /*a:2:{s:93:"E:\phpstudy\WWW\xzj\application\home\view\defaults\column\content\investmentpark_content.html";i:1537947206;s:62:"E:\phpstudy\WWW\xzj\application\home\view\defaults\layout.html";i:1537942474;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
     ...
     <div class="sitesearch">
      <div class="sitesearbox">
        ...
        <div class="hotsear">招商项目：
            <?php $sql_list=model('ModelField')->getDataList("catetype", "status=1 and create_time <1537947207", "*", "", "orders asc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<a class="section" href="<?php echo url('index/index'); ?>"> 首页</a>&gt;
    ...
    <a class="section" href="<?php echo htmlentities($vo['url']); ?>"> <?php echo htmlentities($vo['title']); ?></a>&gt; 
    <?php endforeach; endif; else: echo "" ;endif; ?>
...
<!-- Indus title end -->
<!--main内容 begin-->
<div class="Indusonecon">
<!--xq left-begin-->
<div class="xq_left f_l">
	<!--第一部分头部 begin-->
	<div class="xq_info_main">
	<!--Indus推荐图begin-->
       <div class="recomparkimg">
	   <!-- 代码 开始 -->

    <div class="focusbox">         
        <div class="focusimg" style="width: 430px;height: 380px">
        	
        	<img src="/public/uploads/<?php echo htmlentities($data['logo']['path']); ?>" alt="<?php echo htmlentities($data['title']); ?>" style="width: 100%;height: 100%">
...
<!--Indus推荐图end-->	
<!--推荐图右侧详情 begin-->
<div class="xqL_info f_r">

	<div class="rank_title"><?php echo htmlentities($data['title']); ?></div>
    <div class="rank_p">
    <span class="padR-10">发布时间：</span><?php echo date('Y-m-d',$data['create_time']); ?></div>
	<div class="rank_p"><span class="padR-10">产业类型：</span><?php echo getCateType($data['category']); ?>
	 </div>
    <div class="rank_p"><span class="padR-10">基础设施：</span><?php echo htmlentities($data['infrastructure']); ?></div>
    <div class="rank_p"><span class="padR-10">园区面积：</span><?php echo htmlentities($data['volume']); ?>平米</div>
    <div class="rank_p"><span class="padR-10">土地价格：</span><?php echo htmlentities($data['price']); ?>万每平米</div>
    <div class="rank_p"><span class="padR-10">投资规模：</span><?php echo htmlentities($data['scale']); ?>万以内</div>
	<div class="rank_p"><span class="padR-10">园区地址：</span><?php echo area($data['provinces']); ?><?php echo area($data['city']); ?><?php echo area($data['district']); ?></div>
  <div class="rank_p"><span class="padR-10">园区联系人：</span><?php echo htmlentities($data['contacts']); ?></div>
	<div class="rank_p"><span class="padR-10">联系方式：</span><span class="fc_r20"><?php echo htmlentities($data['telephone']); ?></span></div>
  <div class="rank_p"><span class="padR-10">园区地址：</span><?php echo area($data['province']); ?>><?php echo area($data['city']); ?>><?php echo area($data['district']); ?>><?php echo htmlentities($data['address']); ?></div>
...
<!--项目介绍begin-->
  ...
  <div class="layui-tab-content" style="border-left: 1px solid #eee;border-bottom: 1px solid #eee;border-right: 1px solid #eee;">
    <div class="layui-tab-item layui-show">
      <?php echo htmlspecialchars_decode($data['survey']); ?>
    </div>
    <div class="layui-tab-item"><?php echo htmlspecialchars_decode($data['policy']); ?></div>
    <div class="layui-tab-item"><?php echo htmlspecialchars_decode($data['dynamic']); ?></div>
    <div class="layui-tab-item"><?php echo htmlspecialchars_decode($data['album']); ?></div>
...
<!--xq left-end-->
<!--右侧 begain-->
        <div class="inspright f_r">
        	<!--one end-->
        	
						<div class="inspR_rank">
            	<h4 class="sdtit"><span><img src="/public/static/home/image/icon2.jpg"></span>
            	<span class="more"><a href="/index.php/investmentpark">更多&gt;&gt;</a></span>最新招商园区</h4>
                
              <ul class="inspRlink">
			           <?php $sql_list=model('ModelField')->getDataList("investmentpark", "status=1 and create_time <1537947207", "id,title,cname,province,city", "", "create_time desc", "0,12", null, 18, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
			   					 <li onmouseover="this.style.backgroundColor=&#39;#f1f1f1&#39;" onmouseout="this.style.backgroundColor=&#39;#ffffff&#39;" style="background-color: rgb(255, 255, 255);">
			   			       <a href="/index.php/investmentpark/<?php echo htmlentities($vo['id']); ?>">
                    <span class="num top3" style="color: red"><?php echo htmlentities($vo['id']); ?></span>
                    <span class="tit"><?php echo htmlentities($vo['title']); ?></span></a>
                  	<span style="float: right;padding-right: 10px;"><?php echo area($vo['city']); ?></span>
            ...
            <!--one end-->
            <div class="area2 blank10"></div>
        	<!--one begin-->
        	<div class="inspR_rank">
            	<h4 class="sdtit"><span><img src="/public/static/home/image/icon1.jpg"></span>
            	<span class="more"><a href="/index.php/investmentpark">更多&gt;&gt;</a></span>热点招商园区</h4>
                
                <ul class="inspRlink">
                 	<?php $sql_list=model('ModelField')->getDataList("investmentpark", "status=1 and create_time <1537947207", "id,title,cname,province,city", "", "hits desc", "0,12", null, 18, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
                   <li onmouseover="this.style.backgroundColor=&#39;#f1f1f1&#39;" onmouseout="this.style.backgroundColor=&#39;#ffffff&#39;" style="background-color: rgb(255, 255, 255);">
                     <a href="/index.php/investmentpark/<?php echo htmlentities($vo['id']); ?>">
                    <span class="num top3" style="color: red"><?php echo htmlentities($vo['id']); ?></span>
                    <span class="tit"><?php echo htmlentities($vo['title']); ?></span></a>
...
让招商引资更简单 更精准 更高效</p>
    ...
    <div class="fw_dt fl">
        ...
        <div class="fw_dt_info">
            <ul class="clearfix">
                <?php $sql_list=model('ModelField')->getDataList("journalism", "status=1 and create_time <1537947207", "id,cname,title", "", "create_time desc", "6", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
